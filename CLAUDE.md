...
**Los 93 que faltan (todos multi-step, 4-7 ops):** combinaciones más profundas de las mismas familias — −50/overflow con through parcial sobre estados con particiones, y secuencias planta/grupo donde una grieta chica de un paso temprano se agranda. Criterio invariable: minimizar seed → regresión nombrada → fix de raíz, nunca parche.
