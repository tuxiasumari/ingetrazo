...
**Los 76 que faltan (todos multi-step profundos, 3-7 ops):** estados con múltiples stacks Ctrl sobre caras inclinadas, −50 sobre particiones acumuladas, y secuencias planta/grupo largas. Ya no hay repros cortos — cada seed requiere entender 4+ pasos de estado. Criterio invariable: minimizar seed → regresión nombrada → fix de raíz, nunca parche.
